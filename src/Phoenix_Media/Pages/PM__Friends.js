      ...
      <div className="pm__friends-wrap">
        ...
        <div className="pm__friends-wrap_content">
          <div className="pm__friends-wrap_content-card">
            ...
            <div className="pm__friends-wrap_content-card_grid">
              <Link
            ...
            <p>
              Author, Youtuber, Gamer... is thre nothing E L Restrick can't do?!
              self published at just <strong>16 years old</strong> when she
              released the first in her 'darkness' trilogy, she first appeared
              on my original channel starring in the popular monday madness
              series. Click the links to check her out!
            </p>
          </div>
          <div className="pm__friends-wrap_content-card">
            ...
            <p>
              Sanitence is an aspiring fifa youtuber and creator of the 'aiming
              for the title' head to head career mode series. he currently has
              <strong>830</strong> subscribers and over
              <strong>13 thousand</strong> views! quality content and an
              all-round funny human being, go click his links and show him some
              love
            </p>
          </div>
          <div className="pm__friends-wrap_content-card">
            ...
            <p>
              ...
              <strong>parkour enthusiast.</strong> Watch this space for when he
              starts releasing videos!
            </p>
          </div>
        </div>
      </div>
